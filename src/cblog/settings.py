...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.cxxd7rmzvre2.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'hectorblog' # please enter your s3 bucket name
