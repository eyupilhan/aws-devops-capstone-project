...
![Django](https://img.shields.io/badge/Django-Web%20Application-green)
...
This project strengthened my practical experience in designing and deploying cloud-native applications on AWS using DevOps principles.

It also improved my understanding of highly available architectures, infrastructure automation, networking, security, and the integration of multiple AWS managed services into a single production-inspired solution.
